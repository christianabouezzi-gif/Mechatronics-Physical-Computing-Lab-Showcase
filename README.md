...
* Load Metrics: The design achieved a final estimated failure capacity of 65.698 oz against a calculated build expense of \$223.66, yielding a precise operational efficiency factor of $\text{oz}/\text{\$}^{-1}$ (or $\frac{\text{oz}}{\text{\$}}$).
